...
class AdvansedSqlSelectQueryBuilder : public SqlSelectQueryBuilder
{
public:
	...
	AdvansedSqlSelectQueryBuilder& AddWhere(std::string columnName_, std::string operator_, std::string value_);
};
